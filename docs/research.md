...
The shared pointer layer follows Karabiner-Elements' official [pointing-button manipulator](https://karabiner-elements.pqrs.org/docs/json/complex-modifications-manipulator-definition/from/) and [variable condition](https://karabiner-elements.pqrs.org/docs/json/complex-modifications-manipulator-definition/conditions/variable/) models. Karabiner owns the conditioned button press while the already-running native shell handles continuous Accessibility motion and wheel events, avoiding a second shortcut daemon.
