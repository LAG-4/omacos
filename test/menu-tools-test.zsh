...
"$project_root/scripts/menu.zsh" run style.bar.position.left
"$project_root/scripts/menu.zsh" run style.bar.position.right
...
rg -Fq 'bar position left' "$temporary_directory/cli.log"
rg -Fq 'bar position right' "$temporary_directory/cli.log"
